...
def pure_conv_audio_to_deepspeech(audio,
    ...
    audio_len_s = float(audio.shape[0]) / audio_sample_rate # 71.18475
    # print("!!!!!!", float(audio.shape[0]), audio_sample_rate) # 1138956.0 16000
    if num_frames is None:
        num_frames = int(round(audio_len_s * video_fps))
    else:
        video_fps = num_frames / audio_len_s
    # print(num_frames) 3559
    # print(network_output.shape) (3559, 1, 29)
    ...
    # print(network_output.shape) (3559, 29)
    # Make windows:
    zero_pad = np.zeros((int(audio_window_size / 2), network_output.shape[1])) # audio_window_size == 1
